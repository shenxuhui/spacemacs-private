...
you should place your code here."
  ...
  (setq explicit-shell-file-name "/bin/bash") ;; also change local shell
  ;;; tramp setting end
 ...
 ;;; python jump start
  (with-eval-after-load 'anaconda-mode
    ...
    (define-key anaconda-mode-map (kbd "C-c g D")  'helm-pydoc)
    (define-key anaconda-mode-map (kbd "C-c g =")  'anaconda-mode-find-assignments)
    (define-key anaconda-mode-map (kbd "C-c g s")  'anaconda-mode-find-references)
...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (web-mode web-beautify tagedit slim-mode scss-mode sass-mode pug-mode prettier-js less-css-mode impatient-mode simple-httpd helm-css-scss haml-mode emmet-mode company-web web-completion-data youdao-dictionary yasnippet-snippets yapfify wttrin ws-butler writeroom-mode wolfram-mode winum which-key volatile-highlights vi-tilde-fringe vala-snippets vala-mode uuidgen use-package unfill treemacs-projectile tramp-term toc-org thrift symon switch-window sublimity string-inflection stan-mode spaceline-all-the-icons smeargle shell-pop scad-mode restart-emacs rainbow-delimiters qml-mode pytest pyenv-mode py-isort popwin pkgbuild-mode pippel pipenv pip-requirements persp-mode pcre2el password-generator paradox overseer orgit org-projectile org-present org-pomodoro org-mime org-download org-bullets org-brain open-junk-file nameless mwim multi-term move-text mmm-mode matlab-mode markdown-toc magit-svn magit-gitflow magit-gh-pulls macrostep lorem-ipsum logcat live-py-mode linum-relative link-hint kivy-mode keyfreq insert-shebang indent-guide importmagic ibuffer-projectile hungry-delete htmlize hoon-mode hl-todo highlight-parentheses highlight-numbers highlight-indentation helm-xref helm-themes helm-swoop helm-rtags helm-pydoc helm-purpose helm-projectile helm-org-rifle helm-mode-manager helm-make helm-gtags helm-gitignore helm-git-grep helm-flx helm-descbinds helm-cscope helm-company helm-c-yasnippet helm-ag google-translate google-c-style golden-ratio gnuplot gitignore-templates github-search github-clone gitconfig-mode gitattributes-mode git-timemachine git-messenger git-link git-gutter-fringe git-gutter-fringe+ gist gh-md ggtags fuzzy font-lock+ flyspell-correct-helm flycheck-ycmd flycheck-rtags flycheck-pos-tip flycheck-bashate flx-ido fish-mode fill-column-indicator fancy-battery eyebrowse expand-region evil-visualstar evil-visual-mark-mode evil-unimpaired evil-tutor evil-surround evil-org evil-numbers evil-nerd-commenter evil-matchit evil-magit evil-lisp-state evil-lion evil-indent-plus evil-iedit-state evil-goggles evil-exchange evil-escape evil-ediff evil-cleverparens evil-args evil-anzu eval-sexp-fu eshell-z eshell-prompt-extras esh-help erc-yt erc-view-log erc-social-graph erc-image erc-hl-nicks elisp-slime-nav editorconfig ebuild-mode dumb-jump dotenv-mode doom-themes doom-modeline dockerfile-mode docker disaster diminish diff-hl define-word cython-mode counsel-projectile company-ycmd company-statistics company-shell company-rtags company-quickhelp company-c-headers company-anaconda column-enforce-mode clean-aindent-mode clang-format centered-cursor-mode browse-at-remote auto-yasnippet auto-highlight-symbol auto-dictionary auto-compile arduino-mode aggressive-indent ace-link ace-jump-helm-line ac-ispell))))
(custom-set-faces
